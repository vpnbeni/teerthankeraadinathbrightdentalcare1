                ...
                {slots.map((slot) => (
                  <button
                    ...
                    className={`p-3 rounded-lg border-2 text-sm font-medium transition-colors ${
                      selectedSlot === slot
                        ? "border-[#346870] bg-[#346870] text-white"
                        : "border-gray-200 bg-white text-gray-700 hover:border-[#346870] hover:bg-[#346870] hover:bg-opacity-10"
                    }`}
                  >
                    {formatTime(slot)}
                  </button>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div className="text-sm text-blue-700">
            ...
            <p>
              Each appointment slot is 1 hour long. Please arrive 10 minutes
              early for check-in.
            </p>
          </div>
        </div>
